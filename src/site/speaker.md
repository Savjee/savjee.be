...
<div class="max-w-4xl mt-8 mb-10">
    <h1 class="text-5xl font-extrabold text-savjeeblue dark:text-savjeewhite mb-4">Speaking</h1>
...
<h2 class="text-3xl font-bold mb-6 mt-2">Past talks</h2>

<div class="space-y-4">
{% for talk in collections.talks %}
    <article class="border border-savjeelightgrey4 dark:border-savjeelightgrey3/30 rounded-lg p-5 md:p-6">
